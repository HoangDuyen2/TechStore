    ...
    var retina = window.devicePixelRatio > 1 ? true : false;
      if(retina) {
        if ($(".dark-theme").length > 0) {
          $('#logo_header').attr({src:'/admin/images/logo/logo-dark@2x.png',width:'154px',height:'52px'});
        } else {
          $('#logo_header').attr({src:'/admin/images/logo/logo@2x.png',width:'154px',height:'52px'});
        }
      }
  };  
